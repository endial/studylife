...
![img](img/bg2019102005.png)

本文复制自阮一峰的[Tmux 使用教程](http://www.ruanyifeng.com/blog/2019/10/tmux.html)
...
类似的终端复用器还有 GNU 的 Screen。Tmux 与它功能相似，但是更易用，也更强大。
...
本文来源 [Endial Fang](https://github.com/endial) @ [Github.com](https://github.com) ([项目地址](https://github.com/endial/studylife.git))
